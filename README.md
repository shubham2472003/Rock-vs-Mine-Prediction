...
<img width="1634" height="1013" alt="workflow" src="https://github.com/user-attachments/assets/60f8331f-f72a-43fb-9486-689bd3bec715" />
...
1. This is my first machine learning project where i learnt about logistic regression model which is used for binary classification.
2. I also learned about how different python libraries like scikit learn, numpy and pandas can be used to build and train the model.
3. Model evaluation using input data was also done in this project.
